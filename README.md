...
The platform streamlines the analysis of academic results for **4th-year middle school students** and assists in the **orientation (Tawjih) process** through automated calculations, structured data management, and powerful reporting tools.
...
**Al Wajeez Tawjih Pro** solves this problem by providing a centralized platform that:
...
Example sections that can be shown:

- Dashboard overview  
- Excel import interface  
- Student dataset table  
- Orientation calculation results  

---

# Target Users

Al Wajeez Tawjih Pro is designed for:
